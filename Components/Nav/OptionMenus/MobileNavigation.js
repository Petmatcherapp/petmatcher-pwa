...
export default function MobileNavigation({ activeRoute }) {
  return (
    <nav className="display-flex-column width-100">
      <ul
        className={`${styles.navUl} display-flex-column align-center margin-0`}
      >
        <Link href="/create">
          <li className={`${styles.imageContainer}`}>
            <CreateIcon active={activeRoute?.create} />
      ...
      <div>
        <ul className={`${styles.navUl}`}>
          <div className="display-flex-row space-evenly justify-around bottom-margin-large">
            <Link href="/store">
              <li className={`${styles.imageContainer}`}>
                <StoreIcon active={activeRoute?.store} />
                <small className="bottom-margin-none">Store</small>
              </li>
            </Link>
            <Link href="/groups">
              <li className={`${styles.imageContainer}`}>
                <GroupIcon active={activeRoute?.groups} />
          ...
          <div className="display-flex-row space-evenly justify-around">
            <Link href="/animals">
              <li className={`${styles.imageContainer}`}>
                <AnimalIcon active={activeRoute?.animals} />
            ...
            <Link href="/">
              ...
              >
                <PostIcon active={activeRoute?.posts} />
                <small className="bottom-margin-none">Posts</small>
              </li>
            </Link>
            <Link href="/stories">
              <li className={`${styles.imageContainer}`}>
                <StoryIcon active={activeRoute?.stories} />
