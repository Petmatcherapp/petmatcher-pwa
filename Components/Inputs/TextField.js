    ...
    return (
        <div className="display-inline-flex-column">
            ...
            <label htmlFor={id} className="gradient-2 padding-2 border-radius-12 display-inline-flex align-center clickable-shadow">
                <input onChange={handleChange} onFocus={handleFocus} id={id} value={value} type={type} className={`${styles.textField} width-100 height-100 background-white border-radius-10 padding-5 padding-left-right-10`} />
            </label>
        </div>
    )
}