...
export default function Post({ postData }) {
    ...
    return (
        <div className={`${styles.postContainer} border-radius-20 display-flex-column normal-shadow`}>
            ...
            <div onClick={() => handlePostClick("actions")} className={`${styles.postActionsContainer} ${actionsVisibility} height-100 width-100 border-radius-20`}>
                <PostActions />
            </div>
        </div>
    )
