...
export default function Button({ buttonText, gradientNum, onClick, disabled }) {
  ...
  return (
    <button
      onClick={handleClick}
      disabled={disabled}
      className={`clickable-shadow ${styles.button} gradient-${gradientNum} padding-2 border-radius-10 cursor-pointer display-inline-flex align-center justify-center`}
    >
